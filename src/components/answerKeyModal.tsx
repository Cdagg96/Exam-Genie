...
import { DownloadAnswerKeyPDF } from "@/components/ExamDownload";
    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full shadow-xl max-h-[80vh] overflow-y-auto relative">
                ...
                <button
                    onClick={() => { DownloadAnswerKeyPDF(exam); }}
                    className="absolute top-5 right-16 text-black hover:text-gray-500 text-xl"
                >
                    <svg
